...
export default function Account() {
  ...
  const stats = user?.stats || { diamonds: 0, score: 0, rank: "Novice", level: 1, gifts: 0, levelStars: {} }

  // Calculate total stars earned
  const totalStars = Object.values(stats.levelStars || {}).reduce((acc, s) => acc + s, 0)
  ...
  async function handleProfileSave() {
    ...
    setSuccess("")
    try {
      const res = await api.post("/auth/me/update", {
